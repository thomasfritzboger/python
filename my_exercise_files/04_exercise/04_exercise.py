...
for i in range(1992,2016):
    mask_osterbro = (dd[:,0] == i) & (dd[:,1] == 2) 
    res1 = number_of_people_per_neighbourhood(i,mask_osterbro)
    osterbro.append(res1)
    mask_vesterbro = (dd[:,0] == i) & (dd[:,1] == 4) 
    res2 = number_of_people_per_neighbourhood(i,mask_vesterbro)
    vesterbro.append(res2)
